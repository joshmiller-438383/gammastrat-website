      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-16">
          ...
          <div className="lg:w-80 flex-shrink-0">
            <p className="text-xs font-semibold text-[#2DD4BF] uppercase tracking-widest mb-3">Need assistance? Contact our experts.</p>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-10">Connect with us now</h2>

            <div className="space-y-8">
              <ContactItem icon="✉" label="Email" value="email@domain.com" />
              <ContactItem icon="📍" label="Office" value={`1234 S Rangeline Pkwy, Suite 200\nSalt Lake City, Utah, USA`} />
              <ContactItem icon="📞" label="Phone" value="+1 (555) 000-0000" />
            </div>
          </div>
